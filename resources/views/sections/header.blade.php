<header id="header" class="shadow-xl py-3 bg-white">
    <div class="flex pt-2 px-10 max-w-6xl m-auto">
        <div class="logo w-3/4">
            <a href="/">
                <div class="flex">
                    <img class="w-1/2 rounded-full float-left mr-6" src="{{url('assets/img/edion-profile.png')}}" alt="Photo of Espiridion Larosa" style="width: 64px;height:100%;">
                    <h1 class="w-1/2 text-xl text-2xl font-bold text-gray-800 hover:text-blue-800">Espiridion Larosa Jr. 
